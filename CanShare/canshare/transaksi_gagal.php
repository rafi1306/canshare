    ...
    <div class="w-full bg-red-300 fixed flex flex-row">
        ...
        <div class="text-white px-6 py-3 flex-grow">
            <div class="flex flex-row-reverse">
                ...
                <a href=""><?php echo $profil['nama_lengkap']?></a>
            </div>
        </div>
    </div>
                ...
                <div class="h-full">
                    <div class="flex flex-col h-full">
                        ...
                        <div class="flex flex-row justify-center mx-6 gap-x-3">
                                ...
                                <a href="transaksi_gagal.php"><div class="bg-red-100 px-10 py-3 font-medium rounded-t-2xl">Gagal</div></a>
                        ...
                        <div class="bg-red-100 p-10 rounded-3xl h-full">
                            ...
                            INNER JOIN donasi ON transaksi.id_donasi = donasi.id_donasi WHERE transaksi.id_user = '$_SESSION[id_user]' AND status_validasi = 'GAGAL'");
