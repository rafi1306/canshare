    ...
    <div class="grid justify-items-center w-full min-h-screen">
        <div class="grid self-center">
            <div class="bg-red-100 shadow-lg overflow-hidden max-w-lg rounded-2xl self-center p-10">
                ...
                <center><img src="assets/37ee585734f72e6bd2d3102f6994813b.png" width="75px"></center>
                    <b class="text-center mt-3 font-bold text-2xl text-red-500">Yuk cek emailmu untuk ganti kata sandi</b>
